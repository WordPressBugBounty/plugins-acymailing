...
= 📥 ENHANCE DELIVERABILITY AND ENSURE GDPR COMPLIANCE: =
...
= 👤 EFFICIENT CONTACT LIST MANAGEMENT WITH GDPR COMPLIANCE: =
...
If you don't find the information you're looking for, you can find the complete documentation here: [https://docs.acymailing.com/](https://docs.acymailing.com/)
...
= 10.0.1 - January 28, 2025 =
* Improve the display of the creation date in the template listing that could be misinterpreted with the name
* Add the possibility to sort the subscribers by their user account ID.

* We fixed an error message happening for users with old versions of some add-ons like the ones for Community Builder and Event Booking.
* Fixed issue when displaying prices with discounts in WooCommerce dynamic content when sending campaigns.
